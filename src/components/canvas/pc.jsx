...
Command: npx gltfjsx@6.2.12 public/desktop_pc/scene.gltf 
...
const computer = (props) => {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('./desktop_pc/scene.gltf')
            ...
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              ...
              <group name="amelia_37" position={[-0.197, 0.901, 0]} rotation={[0, 0.864, 0]}>
                <group name="GLTF_created_0">
                  ...
                  <skinnedMesh name="Object_37" geometry={nodes.Object_37.geometry} material={materials.terrarium1ame} skeleton={nodes.Object_37.skeleton} />
